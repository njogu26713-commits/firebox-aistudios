...
export default function FireboxAIStudio() {
  ...
  const requestBuildPlan = useCallback(async (requestText) => {
    ...
    setBuildPlan(null);
    try {
      if (["groq-agent", "openrouter-agent", "openai-agent", "gemini-agent"].includes(aiProvider)) {
