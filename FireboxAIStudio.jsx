...
export default function FireboxAIStudio() {
  ...
  const requestBuildPlan = useCallback(async (requestText) => {
    ...
    setBuildPlan(null);
    try {
      if (["cloud", "groq-agent", "openrouter-agent", "openai-agent", "gemini-agent", "claude-agent"].includes(aiProvider)) {
